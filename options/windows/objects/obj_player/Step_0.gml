...
if (place_meeting(x+xspeed, y, obj_colider)){xspeed=0}
if (place_meeting( x, y+yspeed, obj_colider)){yspeed=0}
...
if (sprite_index = Spr_KrisWd){facing_direction = 2}
if (sprite_index = Spr_KrisWu){facing_direction = 3}
if (sprite_index = Spr_KrisWr){facing_direction = 0}
if (sprite_index = Spr_KrisWl){facing_direction = 1}